...
DOTFILES_GITHUB="https://github.com/td72/dotfiles.git"; export DOTFILES_GITHUB
...
dotfiles_download() {
    ...
    if is_debug; then
        ...
        if is_exists "git"; then
            ...
            # curl or wget
            local tarball="https://github.com/td72/dotfiles/archive/master.tar.gz"
